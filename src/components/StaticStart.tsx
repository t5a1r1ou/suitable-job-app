...
const StaticStart = memo(() => {
  return (
    <>
      ...
      <h3 className="static_title">価値観診断</h3>
      <div className="static_item">
        <h3 className="static_item_title">価値観診断でわかること</h3>
        <p className="static_item_desc">
          仕事に求める価値観や、どのような働き方を重視しているかなどの嗜好性を判定します。
        </p>
      </div>
      <h3 className="static_title">性格診断</h3>
      <div className="static_item">
        <h3 className="static_item_title">性格診断でわかること</h3>
        <p className="static_item_desc">
